...
p2.age = 28
p2.city = "上海"
fmt.Printf("p2=%#v\n", p2) //p2=&main.person{name:"bbj1030", city:"上海", age:28}
```
...
p3.age = 30
p3.city = "成都"
fmt.Printf("p3=%#v\n", p3) //p3=&main.person{name:"bbj1030", city:"成都", age:30}
```

`p3.name = "bbj1030"`其实在底层是`(*p3).name = "bbj1030"`，这是Go语言帮我们实现的语法糖。
...
fmt.Printf("p5=%#v\n", p5) //p5=main.person{name:"bbj1030", city:"北京", age:18}
```
...
fmt.Printf("p6=%#v\n", p6) //p6=&main.person{name:"bbj1030", city:"北京", age:18}
```
...
```go
p9 := newPerson("张三", "镇江", 90)
fmt.Printf("%#v\n", p9) //&main.person{name:"张三", city:"镇江", age:90}
```
...
func main() {
	...
	fmt.Printf("user1=%#v\n", user1)//user1=main.User{Name:"bbj1030", Gender:"男", Address:main.Address{Province:"山东", City:"威海"}}
}
```
...
func main() {
	...
	fmt.Printf("user2=%#v\n", user2) //user2=main.User{Name:"bbj1030", Gender:"男", Address:main.Address{Province:"山东", City:"青岛"}}
}
```
